...
#keep below:
#location of the csv files in same folder otherwise direct
filename = "/usr/share/rpimonitor/web/addons/dorkbox/stations.csv"
...
# create a placeholder for the station url
#    def tempurl():
#        tempurl=(url)
...
#result_json = probe_file('tempurl')
